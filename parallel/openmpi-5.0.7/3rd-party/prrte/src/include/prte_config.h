...
#define PRTE_CONFIGURE_CLI " \'--disable-option-checking\' \'--prefix=/home/ramazan/Documents/GitHub/GalacticSupercomputing/serial/openmpi-5.0.7\' \'--enable-prte-ft\' \'--with-proxy-version-string=5.0.7\' \'--with-proxy-package-name=Open MPI\' \'--with-proxy-bugreport=https://www.open-mpi.org/community/help/\' \'--disable-devel-check\' \'--enable-prte-prefix-by-default\' \'--cache-file=/dev/null\' \'--srcdir=.\'"

/* Date when PMIx was built */
#define PRTE_CONFIGURE_DATE "Sun Feb 23 13:05:42 UTC 2025"

/* Hostname where PMIx was built */
#define PRTE_CONFIGURE_HOST "ramazan-VirtualBox"

/* User who built PMIx */
#define PRTE_CONFIGURE_USER "ramazan"
...
#define PRTE_IDENT_STRING "3.0.8"
...
#define PRTE_PACKAGE_STRING "Open MPI ramazan@ramazan-VirtualBox Distribution"
...
#define PRTE_PROXY_VERSION_STRING "5.0.7"
...
#define PRTE_RELEASE_VERSION 8

/* The repository version PMIx Reference Run-Time Environment */
#define PRTE_REPO_REV "2025-02-23"
