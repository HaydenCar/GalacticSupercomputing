...
#define PMIX_CONFIGURE_CLI " \'--disable-option-checking\' \'--prefix=/home/ramazan/Documents/GitHub/GalacticSupercomputing/serial/openmpi-5.0.7\' \'--without-tests-examples\' \'--enable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--disable-devel-check\' \'--cache-file=/dev/null\' \'--srcdir=.\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Sun Feb 23 13:05:15 UTC 2025"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "ramazan-VirtualBox"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "ramazan"
...
#define PMIX_PACKAGE_STRING "PMIx ramazan@ramazan-VirtualBox Distribution"
